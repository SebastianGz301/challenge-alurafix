...
export default ()=>{
    return(
        <Footer>
            <img  src={Logo} />
            <Div>
                <P>&copy; 2024 Sebastian Gomez-AluraLatam</P>
                <A href="https://github.com/SebastianGz301" target="_blank" rel="noopener noreferrer"><i className="fa-brands fa-github"></i></A>
                <A href="" target="_blank" rel="noopener noreferrer"><i className="fa-brands fa-linkedin"></i></A>
            </Div>
            <P><Stronge>Alura Latam</Stronge></P>
        </Footer>
    )
}